...
while x < 10 and x != 6:
    print(x)
    x += 2
print("'x' alcanzó un valor crítico:",x,",por lo tanto se interrumpirá el procedimiento.\n")
...
while y < 10:
    ...
    y += 2
    if y == 6:
        print("'y' alcanzó un valor crítico:",x,",por lo tanto se interrumpirá el procedimiento.\n")
        break
